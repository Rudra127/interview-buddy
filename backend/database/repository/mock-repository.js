import MockInterviewSession from "../models/mock.js";
...
export default class MockInterviewRepository {
    ...
    async bookSession(sessionId, userId, bookingData) {
        try {
            ...
            if (!updatedSession) {
                return { message: "Failed to book slot", status: 500 };
            }

            return { session: updatedSession, status: 200 };
        } catch (err) {
